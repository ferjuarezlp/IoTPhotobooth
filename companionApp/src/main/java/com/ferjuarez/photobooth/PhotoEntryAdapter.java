 ...
 */
public class PhotoEntryAdapter extends FirebaseRecyclerAdapter<PhotoEntry, PhotoEntryAdapter.DoorbellEntryViewHolder> {
    ...
    public PhotoEntryAdapter(Context context, DatabaseReference ref) {
        super(PhotoEntry.class, R.layout.photo_entry, DoorbellEntryViewHolder.class, ref);
            ...
            if (model.getImage() != null) {
                ...
                if (bitmap != null) {
                    ...
                    Drawable placeholder =
                            ContextCompat.getDrawable(mApplicationContext, R.mipmap.ic_launcher);
